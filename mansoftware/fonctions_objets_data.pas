...
{$IFDEF VERSIONS}
  gver_fonctions_Objets_Data : T_Version = ( Component : 'Gestion des objets dynamiques créés par les données' ;
                                             FileUnit : 'fonctions_Objets_Data' ;
...
uses u_formmaindb, U_FormMainIni, fonctions_string, SysUtils, TypInfo, Dialogs,
     ...
     fonctions_forms, fonctions_system, fonctions_components,
